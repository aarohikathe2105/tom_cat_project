<form action="action_page.php">
  <div class="container">
    ...
    <input type="text" placeholder="7774901405" name="mobile" id="mobile" required>
    <br>
    ...
    <button type="yes" class="registerbtn">Register</button>
  </div>
  <div class="container signin">
    <p>Already have an account? <a href="#">Sign in</a>.</p>
  </div>

   <h1> Thankyou, Happy Learning Aarohi</h1>
